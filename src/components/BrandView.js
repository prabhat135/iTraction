...
const BrandImages = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center min-h-screen p-4 md:p-10 bg-gray-900 text-white">
      {/* Description Section */}
      ...
      {/* Brand Images */}
      <div className="relative bg-gray-200 shadow-2xl w-full md:w-2/3 h-[400px] md:h-[500px] lg:h-[700px] overflow-hidden rounded-lg">
