      ...
      {testimonials.map((testimonial, index) => {
        ...
        return (
          <SwiperSlide key={index}>
            <div
              className={`flex items-center h-full md:h-[8vw] space-x-4 px-2 py-1 md:px-4 md:py-4 border-[1px] dark:shadow-xl border-zinc-400 rounded-lg ${marginClass}`}
            >
              <img
              ...
              <div className='flex flex-col'>
               ...
               <h4 className="text-xl font-semibold text-black dark:text-white">{testimonial.name}</h4>
