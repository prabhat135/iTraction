...
const Header2 = ({ isVisible }) => {
  ...
  return (
    <div className={`header2 hidden md:flex justify-between items-center px-12 lg:px-20 py-8 fixed top-0 left-0 w-full bg-gradient-to-b from-[#151515] to-transparent z-50 transition-opacity duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
