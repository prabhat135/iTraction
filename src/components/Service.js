...
const Service = () => {
  return (
    <section id="service" className="flex flex-col space-y-8 items-center justify-center w-[100%] h-[70vh] md:h-full bg-[#151515] text-white dark:bg-white dark:text-black">
